 ...
 *
 * Skeleton referenced by UPB, modified for Ajou Univ. SCE394
 */
...
/*
 * Sample run:
 *  ./my_cdev_test p		; print ioctl message
 *  ./my_cdev_test s buf	; write buffer to device
 *  ./my_cdev_test g	 	; read device data
 */

/*
 *  Extra
 *  ./my_cdev_test d		; wait on wait_queue
 *  ./my_cdev_test u		; wait on wait_queue
 */
